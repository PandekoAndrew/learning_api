...
public final class AuthenticationTokenDetails {
    ...
    private AuthenticationTokenDetails(String id, String username, Set<Role> authorities, ZonedDateTime issuedDate, ZonedDateTime expirationDate, int refreshCount, int refreshLimit) {
        this.id = id;
    ...
    public static class Builder {
        ...
        public Builder withAuthorities(Set<Role> authorities) {
